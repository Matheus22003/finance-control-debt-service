...
- edição dos participantes e histórico auditável da dívida;
- pagamentos com confirmação ou rejeição pela conta envolvida;
- liquidação simplificada para reduzir transferências desnecessárias;
- contexto analítico sanitizável para o BFF;
- PostgreSQL com migrations do Entity Framework Core;
